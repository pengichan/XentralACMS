  ...
  const handleClearLogs = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        await fetchLogs(); // refresh — will show only the "cleared" record
      } else {
    ...
    <div className="pam-container">
          ...
          {isSuperAdmin && (
            <button
              ...
              style={{
                ...
                color: '#ffcaca', fontSize: '0.85rem', fontWeight: 600,
              }}
            >
              🗑 Clear Logs
            </button>
      ...
      {showClearConfirm && (
        <div style={{
          ...
          <div style={{
            background: 'rgba(10,16,35,0.98)', border: '1px solid rgba(255,60,60,0.3)',
            borderRadius: '16px', padding: '2rem', width: '420px', maxWidth: '95vw',
          }}>
